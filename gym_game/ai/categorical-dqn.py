...
from tf_agents.replay_buffers import py_hashed_replay_buffer, tf_uniform_replay_buffer
...
from gym_game.envs import CatchMeIfYouCanEnv
...
class TrainEval(object):
    ...
    def __init__(
            self,
            root_dir="C:\\Users\\abpma\\PycharmProjects\\catchmeifyoucan_ai_gym",
            num_iterations=200,
        ...
        with tf.compat.v2.summary.record_if(
            ...
            with tf.device('/gpu:0'):
                ...
                categorical_q_net = categorical_q_network.CategoricalQNetwork(
                    training_env.observation_spec(),
                    training_env.action_spec(),
                    num_atoms=num_atoms,
                ...
                self._replay_buffer = tf_uniform_replay_buffer.TFUniformReplayBuffer(
                    ...
                    batch_size=training_env.batch_size,
...
def main(_):
    ...
    TrainEval(training_env=training_env, **get_run_args()).run()
